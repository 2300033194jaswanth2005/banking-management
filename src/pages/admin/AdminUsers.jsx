...
export default function AdminUsers() {
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      ...
      <input placeholder="Search by name, email or account no..." value={search} onChange={e => setSearch(e.target.value)}
              ...
              <tr key={u.accNo} className="border-t hover:bg-gray-50">
                ...
                <td className="px-4 py-3">
                  <button onClick={() => handleDelete(u.accNo)}
                    className="text-red-500 hover:text-red-700 text-xs font-semibold border border-red-300 px-2 py-1 rounded hover:bg-red-50">
                    Delete
                  </button>
                </td>
              </tr>
