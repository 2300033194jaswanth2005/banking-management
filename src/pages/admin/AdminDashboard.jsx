...
export default function AdminDashboard() {
  ...
  const deposits     = txns.filter(t => t.type === 'DEPOSIT').reduce((s, t)  => s + Number(t.amount), 0)
  const withdrawals  = txns.filter(t => t.type === 'WITHDRAW').reduce((s, t) => s + Number(t.amount), 0)
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
        ...
        <Card title="Total Withdrawals" value={`₹ ${withdrawals.toFixed(2)}`}        color="red" />
      </div>
