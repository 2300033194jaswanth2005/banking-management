...
export default function AdminTransactions() {
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      ...
      <input
        placeholder="Search by account no or type..." value={search}
          ...
          <tbody>
            {filtered.length === 0 ? (
              ...
              <tr key={i} className="border-t hover:bg-gray-50">
                ...
                <td className={`px-4 py-3 font-semibold ${t.type.includes('OUT') || t.type === 'WITHDRAW' ? 'text-red-500' : 'text-green-600'}`}>
                  {t.type}
                </td>
